...
keep = ['Senior', 'Very young (0–9 years)']
...
template = [
	{
	"title": "Old age is the overriding risk factor",
	"subtitle": "Showing age groups as a percentage of those dying from natural heat as a percentage those where vulnerabilities are known. Some data has been significantly influenced by counts taken the Victorian Coroner after the 2009 heatwave. Due to gaps data may not add up to 100",
	"footnote": "",
...
# testo = "-testo"
testo = ''
chart_key = f"oz-datablogs-heat-deaths-risk-datablog-ages-bar{testo}"
